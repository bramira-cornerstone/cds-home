interface TeamLeaderboardStakedBarProps {
  rmv: number;
  stakedRmv: number;
  teamMaxRmv: number;
...
export default function TeamLeaderboardStakedBar({
  rmv,
  stakedRmv,
  teamMaxRmv,
  teamStakedRmvValues,
}: TeamLeaderboardStakedBarProps) {
  ...
  return (
    <div className="w-full">
      <div className="relative h-6 bg-gray-300 rounded-sm overflow-hidden">
        ...
        {/* Overlay text with staked_rmv value centered on bar */}
        <div
        ...
        >
          ...
          >
            ...
            <span className="max-lg:font-normal"> Staked</span>
          </span>
        </div>
      </div>
    </div>
